...
namespace SWA.CRM.D365.Entities.Base
{
	...
	public partial class IncidentResolution : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<SWA.CRM.D365.Entities.Base.IncidentResolutionState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((SWA.CRM.D365.Entities.Base.IncidentResolutionState)(System.Enum.ToObject(typeof(SWA.CRM.D365.Entities.Base.IncidentResolutionState), optionSet.Value)));
				}
				else
				{
					return null;
