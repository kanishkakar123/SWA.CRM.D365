...
namespace SWA.CRM.D365.Entities.Base
{
	...
	public partial class ActivityPointer : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<SWA.CRM.D365.Entities.Base.Letter> activity_pointer_letter
		{
			
			get
			{
				return this.GetRelatedEntities<SWA.CRM.D365.Entities.Base.Letter>("activity_pointer_letter", null);
			}
			
			set
			{
				this.SetRelatedEntities<SWA.CRM.D365.Entities.Base.Letter>("activity_pointer_letter", null, value);
			}
		}
