...
namespace SWA.CRM.D365.Entities.Base
{
	...
	public partial class Appointment : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<SWA.CRM.D365.Entities.Base.AppointmentState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((SWA.CRM.D365.Entities.Base.AppointmentState)(System.Enum.ToObject(typeof(SWA.CRM.D365.Entities.Base.AppointmentState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<SWA.CRM.D365.Entities.Base.QueueItem> Appointment_QueueItem
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<SWA.CRM.D365.Entities.Base.QueueItem>("Appointment_QueueItem", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Appointment_QueueItem");
				this.SetRelatedEntities<SWA.CRM.D365.Entities.Base.QueueItem>("Appointment_QueueItem", null, value);
		...
		public System.Collections.Generic.IEnumerable<SWA.CRM.D365.Entities.Base.SLAKPIInstance> slakpiinstance_appointment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<SWA.CRM.D365.Entities.Base.SLAKPIInstance>("slakpiinstance_appointment", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("slakpiinstance_appointment");
				this.SetRelatedEntities<SWA.CRM.D365.Entities.Base.SLAKPIInstance>("slakpiinstance_appointment", null, value);
		...
		public SWA.CRM.D365.Entities.Base.KnowledgeArticle KnowledgeArticle_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SWA.CRM.D365.Entities.Base.KnowledgeArticle>("KnowledgeArticle_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("KnowledgeArticle_Appointments");
				this.SetRelatedEntity<SWA.CRM.D365.Entities.Base.KnowledgeArticle>("KnowledgeArticle_Appointments", null, value);
		...
		public SWA.CRM.D365.Entities.Base.KnowledgeBaseRecord KnowledgeBaseRecord_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SWA.CRM.D365.Entities.Base.KnowledgeBaseRecord>("KnowledgeBaseRecord_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("KnowledgeBaseRecord_Appointments");
				this.SetRelatedEntity<SWA.CRM.D365.Entities.Base.KnowledgeBaseRecord>("KnowledgeBaseRecord_Appointments", null, value);
		...
		public SWA.CRM.D365.Entities.Base.SLA manualsla_appointment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SWA.CRM.D365.Entities.Base.SLA>("manualsla_appointment", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("manualsla_appointment");
				this.SetRelatedEntity<SWA.CRM.D365.Entities.Base.SLA>("manualsla_appointment", null, value);
		...
		public SWA.CRM.D365.Entities.Base.Opportunity Opportunity_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SWA.CRM.D365.Entities.Base.Opportunity>("Opportunity_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Opportunity_Appointments");
				this.SetRelatedEntity<SWA.CRM.D365.Entities.Base.Opportunity>("Opportunity_Appointments", null, value);
		...
		public SWA.CRM.D365.Entities.Base.SLA sla_appointment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SWA.CRM.D365.Entities.Base.SLA>("sla_appointment", null);
			}
		}
