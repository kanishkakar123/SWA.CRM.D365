...
namespace SWA.CRM.D365.Entities.Base
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<SWA.CRM.D365.Entities.Base.ContactState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((SWA.CRM.D365.Entities.Base.ContactState)(System.Enum.ToObject(typeof(SWA.CRM.D365.Entities.Base.ContactState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public string swa_nationalid
		{
			...
			set
			{
				this.OnPropertyChanging("swa_nationalid");
				this.SetAttributeValue("swa_nationalid", value);
				this.OnPropertyChanged("swa_nationalid");
			}
		}
		...
		public System.Collections.Generic.IEnumerable<SWA.CRM.D365.Entities.Base.Opportunity> opportunity_customer_contacts
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<SWA.CRM.D365.Entities.Base.Opportunity>("opportunity_customer_contacts", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("opportunity_customer_contacts");
				this.SetRelatedEntities<SWA.CRM.D365.Entities.Base.Opportunity>("opportunity_customer_contacts", null, value);
		...
		public System.Collections.Generic.IEnumerable<SWA.CRM.D365.Entities.Base.Opportunity> opportunity_parent_contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<SWA.CRM.D365.Entities.Base.Opportunity>("opportunity_parent_contact", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("opportunity_parent_contact");
				this.SetRelatedEntities<SWA.CRM.D365.Entities.Base.Opportunity>("opportunity_parent_contact", null, value);
		...
		public System.Collections.Generic.IEnumerable<SWA.CRM.D365.Entities.Base.SLAKPIInstance> slakpiinstance_contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<SWA.CRM.D365.Entities.Base.SLAKPIInstance>("slakpiinstance_contact", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("slakpiinstance_contact");
				this.SetRelatedEntities<SWA.CRM.D365.Entities.Base.SLAKPIInstance>("slakpiinstance_contact", null, value);
		...
		public System.Collections.Generic.IEnumerable<SWA.CRM.D365.Entities.Base.Task> swa_contact_task_Customer
		{
			...
			set
			{
				this.OnPropertyChanging("swa_contact_task_Customer");
				this.SetRelatedEntities<SWA.CRM.D365.Entities.Base.Task>("swa_contact_task_Customer", null, value);
				this.OnPropertyChanged("swa_contact_task_Customer");
			}
		}
		...
		public SWA.CRM.D365.Entities.Base.SLA manualsla_contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SWA.CRM.D365.Entities.Base.SLA>("manualsla_contact", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("manualsla_contact");
				this.SetRelatedEntity<SWA.CRM.D365.Entities.Base.SLA>("manualsla_contact", null, value);
		...
		public SWA.CRM.D365.Entities.Base.Account msa_contact_managingpartner
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SWA.CRM.D365.Entities.Base.Account>("msa_contact_managingpartner", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msa_contact_managingpartner");
				this.SetRelatedEntity<SWA.CRM.D365.Entities.Base.Account>("msa_contact_managingpartner", null, value);
		...
		public SWA.CRM.D365.Entities.Base.SLA sla_contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SWA.CRM.D365.Entities.Base.SLA>("sla_contact", null);
			}
		}
