...
namespace SWA.CRM.D365.Entities.Base
{
	...
	public partial class KnowledgeArticleIncident : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<SWA.CRM.D365.Entities.Base.KnowledgeArticleIncidentState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((SWA.CRM.D365.Entities.Base.KnowledgeArticleIncidentState)(System.Enum.ToObject(typeof(SWA.CRM.D365.Entities.Base.KnowledgeArticleIncidentState), optionSet.Value)));
				}
				else
				{
					return null;
