...
namespace SWA.CRM.D365.Entities.Base
{
	...
	public enum swa_casecategoryState
	{
	...
	public partial class swa_casecategory : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<SWA.CRM.D365.Entities.Base.swa_casecategoryState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((SWA.CRM.D365.Entities.Base.swa_casecategoryState)(System.Enum.ToObject(typeof(SWA.CRM.D365.Entities.Base.swa_casecategoryState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// N:1 organization_swa_casecategory
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("organizationid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("organization_swa_casecategory")]
		public SWA.CRM.D365.Entities.Base.Organization organization_swa_casecategory
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SWA.CRM.D365.Entities.Base.Organization>("organization_swa_casecategory", null);
			}
		}
